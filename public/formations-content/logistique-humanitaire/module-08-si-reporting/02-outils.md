...
**Le gabarit de narrative de planification annuelle** — `gabarit-narrative-planification-annuelle-logistique.docx`, disponible dans `04-templates/`. C'est le contrepoint annuel du gabarit de rapport logistique mensuel de ce module : là où celui-ci suit la routine mois après mois (KPI, état de la flotte et des entrepôts, priorités du mois suivant), ce document se rédige une seule fois par an pour poser le contexte externe et les risques logistiques de la zone, le bilan stratégique de l'année écoulée, les priorités de l'année à venir, les ressources humaines de l'équipe logistique et le chronogramme des grandes échéances. Il se produit généralement en fin d'année, en amont du cycle de planification de l'année suivante, et sert de base au dialogue avec votre coordinateur avant l'arbitrage du budget et des priorités opérationnelles.
