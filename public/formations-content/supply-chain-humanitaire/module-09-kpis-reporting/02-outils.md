# Module 09 — KPIs, Reporting & Tableau de Bord Supply Chain
...
**Le gabarit de narrative de planification annuelle** — `gabarit-narrative-planification-annuelle-supply-chain.docx`, disponible dans `04-templates/`. Là où le tableau de bord KPI et le gabarit rapport bailleur/siège de ce module pilotent le mois, ce document structure l'année : contexte externe et risques liés à la chaîne d'approvisionnement, bilan des objectifs de l'année écoulée (réalisations, défis, enseignements à conserver), objectifs stratégiques et méthode pour l'année à venir, ressources humaines de l'équipe Supply Chain, et chronogramme des grandes échéances. Il se rédige une seule fois par an, généralement en fin d'année, en amont du lancement du cycle de planification de l'année suivante, et sert de base au dialogue avec votre coordinateur ou votre desk siège avant l'arbitrage du budget et des priorités opérationnelles.
...
Rassemblez, pour la période concernée, les registres d'achats (dates de demande d'achat, dates de réception, statut de conformité du dossier — issus du cycle vu au Module 02) et les mouvements de stock (sorties, ruptures constatées, issus du Module 05). Si votre organisation utilise un ERP (SAP, LINK), extrayez ces données via Power Query comme vu au Module 08 plutôt que de les ressaisir manuellement — chaque ressaisie manuelle est une source d'erreur et de perte de temps.
...
Ces deux rapports ne couvrent pourtant pas tout le rythme de reporting réel d'un département Supply Chain. Le `gabarit-sitrep-mensuel-supply-chain.docx`, également dans `04-templates/`, est un troisième document, complémentaire, à ne pas confondre avec les deux précédents : c'est un SITREP (situation report) opérationnel, plus court et plus fréquent que le rapport bailleur — produit chaque mois, quand le rapport bailleur peut n'être exigé que trimestriellement — et plus tactique que le rapport siège, puisqu'il se limite à un point d'avancement par domaine (stocks, RH Supply, achats/IR, transport, finance) plutôt qu'à une analyse KPI complète. Utilisez-le pour partager rapidement l'état du mois avec la coordination ou les autres départements, sans attendre le cycle complet des Étapes 1 à 6 ci-dessus.
