...
Vous disposez des mêmes données sous-jacentes pour produire les deux : les registres d'achats du cycle RFQ/PO (Module 02), le fichier de qualification et d'évaluation de vos fournisseurs (Module 04), les mouvements et ruptures de stock de vos deux entrepôts (Module 05), les rapports d'incidents de distribution du mois (Module 06), les délais de transit et de dédouanement de deux commandes internationales retardées (Module 07), et l'extraction Power Query de votre ERP (Module 08).
