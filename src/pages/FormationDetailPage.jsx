  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <main id="main-content">
        ...
        {/* ── Public cible ── */}
        <section className="section-padding-tight border-t border-border bg-surface">
        ...
        <section id="formulaire" className="section-padding border-t border-border bg-surface">
